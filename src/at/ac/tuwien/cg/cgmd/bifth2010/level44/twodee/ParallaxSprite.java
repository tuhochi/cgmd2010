...
public class ParallaxSprite extends Sprite {
	 ...
	 * 
	 * @param texturePart
	 *            A part of an existing texture used to draw this sprite
	 * @param screenWidth
	 *            The width of the screen, used for parallax-style panning
	 * @param screenHeight
	 *            The height of the screen - again, used for parallax-style
	 *            panning
	 */
	...
	/**
	 * Update the position of this sprite based on a given object's position. In
	 * the case of MireRabbit, this should be the rabbit's position.
	 * 
	 * @param x
	 *            The x-coordinate of the focused object
	 * @param y
	 *            The y-coordinate of the focused object
	 */
	...
	/**
	 * Set the vertical correction value. This value will be used to move the
	 * ParallaxSprite vertically independent of other factors.
	 * 
	 * @param yOffset
	 *            The amount of pixels to move the sprite down
	 */
