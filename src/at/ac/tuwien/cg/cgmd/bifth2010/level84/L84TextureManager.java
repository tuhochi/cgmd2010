...
public class L84TextureManager {
	...
	public L84TextureManager(GL10 gl, Context context)
	{
		this.gl = gl;
	...
	public void setTexture(int id)
	{
		try
		{
			int textureid = Integer.parseInt(this.textureMap.get(new Integer(id)).toString());
