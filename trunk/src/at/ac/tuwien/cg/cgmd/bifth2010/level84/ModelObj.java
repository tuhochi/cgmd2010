...
//        	}
	...
	private boolean checkIndex(int indexnumber)
	{
	...
	public void draw(GL10 gl) {
		...
		if (vertexBuffer != null && indexBuffer != null && numIndices > 0) {
			...
			gl.glColorPointer(3, GL10.GL_FLOAT, 0, normalBuffer);
			//gl.glNormalPointer(3, GL10.GL_FLOAT, normalBuffer);
			
			//Draw the vertices as triangles, based on the Index Buffer information
			gl.glDrawElements(GL10.GL_TRIANGLE_STRIP, numIndices, GL10.GL_UNSIGNED_BYTE, indexBuffer);
	...
	*/
	...
	public void update(GL10 gl, double deltaTime) {
		...
		mTrans = Matrix4x4.mult(Matrix4x4.Translate((float)(0.01f * deltaTime), 0.0f, 0.0f), mTrans);
		gl.glPushMatrix();
