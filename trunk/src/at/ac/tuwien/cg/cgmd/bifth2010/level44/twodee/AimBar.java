...
/**
 * This class represents the aiming bar that will appear when the
 * shaman has targetted our rabbit. It consists of a background
 * texture (the "empty bar") and a foreground texture (the "fill")
 * which will be used to compose a bar that fills itself.
 * 
...
public class AimBar extends SpriteContainer {
	 ...
	 * 
	 * @param texture The MireRabbit main texture object that contains the aimbar assets
	 */
	 ...
	 * 
	 * @param progress The progress from 0 (just aimed) to 1 (shooting)
	 */
	...
	/**
	 * This function is overridden to be able to compose the
	 * "filled" part of the progress bar on top of the bar itself.
	 **/
	@Override
